...
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_io_clk]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_io_vsync]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_io_hsync]
set_property IOSTANDARD LVCMOS33 [get_ports hdmi_io_de]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[0]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[1]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[2]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[3]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[4]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[5]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[6]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[7]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[8]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[9]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[10]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[11]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[12]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[13]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[14]}]
set_property IOSTANDARD LVCMOS33 [get_ports {hdmi_io_data[15]}]
